...
class V0 extends Auth {
  ...
  resetPassword(opts) {
    return this.send('POST', '/users/password/reset', opts);
  }
  ...
  /**
   * Get user GDPR information
   * @public
   * @param {TinaSendOpts} opts
   * @param {Object}       params
   * @param {String}       params.id
   */
  requestUserData(opts) {
    return this.send('POST', `/users/data`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  deleteUserDeleteSchedule(opts) {
    return this.send('DELETE', `/users/schedule`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  createUserDeleteSchedule(opts) {
    return this.send('POST', `/users/schedule`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getAllCompaniesByStatusType(opts, params) {
    return this.send('GET', `/companies/status/${params.type}`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getDeviceHistory(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `/things/${params.thingId}/history`,
      opts
    );
  }
  ...
  /**
   * Locations Meta Options
   */

  /**
   * @param {TinaSendOpts} opts
   */
  createLocationMetaOption(opts, params) {
    return this.send(
      'POST',
      `/companies/${params.companyId}/locations/${
        params.locationId
      }/meta/options`,
      opts
    );
   ...
   * @param {TinaSendOpts} opts
   */
  getLocationMetaOptions(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${
        params.locationId
   ...
   * @param {TinaSendOpts} opts
   */
  getLocationMetaOption(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${
        params.locationId
      }/meta/options/${params.optionId}`,
      opts
    );
  }
   ...
   * @param {TinaSendOpts} opts
   */
  updateLocationMetaOption(opts, params) {
    return this.send(
      'PUT',
      `/companies/${params.companyId}/locations/${
        params.locationId
   ...
   * @param {TinaSendOpts} opts
   */
  deleteLocationMetaOption(opts, params) {
    return this.send(
      'DELETE',
      `/companies/${params.companyId}/locations/${
        params.locationId
  ...
  /**
   * Thing Meta - by location and option
   */

  /**
   * @param {TinaSendOpts} opts
   */
  createLocationMeta(opts, params) {
    return this.send(
      'POST',
      `/companies/${params.companyId}/locations/${params.locationId}/things/${
        params.thingId
   ...
   * @param {TinaSendOpts} opts
   */
  updateLocationMeta(opts, params) {
    return this.send(
      'PUT',
      `/companies/${params.companyId}/locations/${params.locationId}/things/${
        params.thingId
   ...
   * @param {TinaSendOpts} opts
   */
  deleteLocationMeta(opts, params) {
    return this.send(
      'DELETE',
      `/companies/${params.companyId}/locations/${params.locationId}/things/${
        params.thingId
  ...
  deleteMarker(opts, params) {
    return this.send(
      'DELETE',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `/maps/${params.mapId}/markers/${params.thingId}`,
      opts
    );
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getReportTemplates(opts) {
    return this.send('GET', `/reports/templates`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getReportTemplate(opts, params) {
    return this.send('GET', `/reports/templates/${params.id}`, opts);
  }
  ...
  createReportTemplate(opts) {
    return this.send('POST', `/reports/templates`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  updateReportTemplate(opts, params) {
    return this.send('PUT', `/reports/templates/${params.id}`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  deleteReportTemplate(opts, params) {
    return this.send('DELETE', `/reports/templates/${params.id}`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getReportCategories(opts) {
    return this.send('GET', `/reports/categories`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  getReportCategory(opts, params) {
    return this.send('GET', `/reports/categories/${params.id}`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  createReportCategory(opts) {
    return this.send('POST', `/reports/categories`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  updateReportCategory(opts, params) {
    return this.send('PUT', `/reports/categories/${params.id}`, opts);
  }
   ...
   * @param {TinaSendOpts} opts
   */
  deleteReportCategory(opts, params) {
    return this.send('DELETE', `/reports/categories/${params.id}`, opts);
  }

  /**
   * @param {TinaSendOpts} opts
   */
  getEmbedReportTemplate(opts, params) {
    return this.send('GET', `/reports/templates/${params.id}/embed`, opts);
  }

  /**
   * @param {TinaSendOpts} opts
   */
  getEmbedReport(opts, params) {
    return this.send('GET', `/reports/${params.id}/embed`, opts);
  }
   ...
   */
  search(opts) {
    return this.send('GET', `/search`, opts);
  }

  /**
   * @param {TinaSendOpts} opts
   */
  deleteRealm(opts, params) {
      return this.send('DELETE', `/realm/${params.application_id}/${params.user_id}`, opts);
  }
}
