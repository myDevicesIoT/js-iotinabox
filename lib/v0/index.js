...
class V0 extends Auth {
  ...
  getInvitedUser(opts, params) {
    return this.send('GET', `/users/invite/${params.inviteCode}`, opts);
  }
  ...
  createInvitedUser(opts, params) {
    return this.send('POST', `/users/invite/${params.inviteCode}`, opts);
  }
  ...
  getAllNotes(opts, params) {
    return this.note(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `${params.ruleId}/notifications/${params.notificationId}/notes`,
      opts
    );
  }
  ...
  getNote(opts, params) {
    return this.note(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `${params.ruleId}/notifications/${params.notificationId}` +
        `/notes/${params.noteId}`,
      opts
    );
  }
  ...
  getAllActions(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `/rules/notifications/${params.notificationId}/actions`,
      opts
    );
  }
  ...
  getAction(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `/rules/notifications/${params.notificationId}` +
