...
class V0 extends Auth {
  ...
  getInvitedUser(opts, params) {
    return this.send('GET', `/users/invite/${params.inviteCode}`, { ...opts, isPublic: true });
  }
  ...
  createInvitedUser(opts, params) {
    return this.send('POST', `/users/invite/${params.inviteCode}`, { ...opts, isPublic: true });
  }
  ...
  getAllActions(opts, params) {
    return this.send(
      'GET',
      `/companies/${params.companyId}/locations/${params.locationId}` +
        `/rules/${params.ruleId}/notifications/${params.notificationId}/actions`,
      opts
    );
  }
