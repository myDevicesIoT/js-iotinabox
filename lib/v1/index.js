...
class V1 extends V0 {
  ...
  createGroup(opts, params) {
    return this.send('POST', `${this.v}/things/${params.thing_id}/groups`, opts);
  }
  ...
  updateGroup(opts, params) {
    return this.send('PUT', `${this.v}/things/${params.thing_id}/groups/${params.group_id}`, opts);
  }
  ...
  deleteGroup(opts, params) {
    return this.send('DELETE', `${this.v}/things/${params.thing_id}/groups/${params.group_id}`, opts);
  }
  ...
  createAttribute(opts, params) {
    return this.send('POST', `${this.v}/things/${params.thing_id}/groups/${params.group_id}/attributes`, opts);
  }
  ...
  updateAttribute(opts, params) {
    return this.send('PUT', `${this.v}/things/${params.thing_id}/groups/${params.group_id}/attributes/${params.attribute_id}`, opts);
  }
  ...
  deleteAttribute(opts, params) {
    return this.send('DELETE', `${this.v}/things/${params.thing_id}/groups/${params.group_id}/attributes/${params.attribute_id}`, opts);
  }
