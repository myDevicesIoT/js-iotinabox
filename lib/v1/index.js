...
class V1 extends V0 {
  ...
  getThingRuleHistory(opts, params) {
    return this.send(
      'GET',
      `${this.v}/things/${params.id}/rules/history`,
      opts
    );
  }
  ...
  createDashboardAlerts(opts) {
    return this.send('POST', `${this.v}/dashboard-alerts`, opts);
  }
  ...
  getSharingRedirect(opts, params) {
    return this.send('GET', `${this.v}/sharing/redirect/${params.code}`, opts);
  }
  ...
  //Resource groups and attributes
  // /v1.0/resources/04bb9c25-0314-4a17-8e5c-4b2c16f215f2/groups/3c450bc0-95c4-11ed-ad54-4f5fb4d6d76c/attributes' \
  createResourceGroup(opts, params) {
    return this.send('POST', `${this.v}/resources/${params.id}/groups`, opts);
  }
  updateResourceGroup(opts, params) {
    return this.send(
      'PUT',
      `${this.v}/resources/${params.id}/groups/${params.groupId}`,
      opts
    );
  }
}
