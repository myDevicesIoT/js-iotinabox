...
class V1 extends V0 {
   ...
   */
  createUses(opts) {
    return this.send('POST', `${this.v}/uses`, opts);
  }
  ...
  updateUses(opts, params) {
    return this.send('PUT', `${this.v}/uses/${params.id}`, opts);
  }
  ...
  deleteUses(opts, params) {
    return this.send('DELETE', `${this.v}/uses/${params.id}`, opts);
  }
   ...
   */
  getUses(opts, params) {
    return this.send('GET', `${this.v}/uses/${params.id}`, opts);
  }
}
